...
/* Generating the proxy using svcutil.exe
     ...
     * svcutil.exe https://api.cipcert.goevo.com/2.1.28/Txn?wsdl /namespace:*,schemas.evosnap.com.Ipc.General.WCF.Contracts.Common.External.Txn  /ct:System.Collections.Generic.List`1 /config:app.config /mergeConfig
     * svcutil.exe https://api.cipcert.goevo.com/2.1.28/DataServices?wsdl /namespace:*,schemas.evosnap.com.Ipc.General.WCF.Contracts.Common.External.DataServices  /ct:System.Collections.Generic.List`1 /config:app.config /mergeConfig
     * 
    ...
    #region Variable Declarations
        ...
        {//The Authorize() operation is used to authorize transactions prior to capture.
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked, ChkForceCloseBatch.Checked));
                }
                ...
                if (_bcs != null) //Process a BankCard Transaction
                {
                    try
                    {
                        ...
                        if (ChkMultiplePartialCapture.Checked)
                        {
                            ...
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.Capture, null, BCDifferenceData, null, null, null, null, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.Capture, null, BCDifferenceData, null, null, null, null, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                        }
                        else
                        {
        ...
        {//The CaptureAll() operation is used to capture all transactions that have been successfully authorized.
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    {
                        if (chkCaptureAllAndSelectiveAsync.Checked)
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureAllAsync, null, null, null, null, null, null, null, captures, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                        else
                            processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureAll, null, null, null, null, null, null, null, captures, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                    }
                }
                catch (Exception ex) { MessageBox.Show(ex.Message); }
                finally { Cursor = Cursors.Default; }
        ...
        {//The CaptureSelective() operation is used to capture a specific list of transactions that have been successfully authorized.
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    if (chkCaptureAllAndSelectiveAsync.Checked)
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureSelectiveAsync, null, null, null, null, null, null, transactionIDs, captures, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                    else
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.CaptureSelective, null, null, null, null, null, null, transactionIDs, captures, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
            ...
            else if (_svas != null) //Process a Stored Value Transaction
            {
                ...
                try
                {
                    ...
                    if (_svas.Tenders.CreditAuthorizeSupport == CreditAuthorizeSupportType.AuthorizeAndCaptureOnly)
                    {
                        ...
                        response = Helper.ProcessBCPTransaction(TransactionType.CaptureAll, null, null, null, null, null, null, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked);
                        if (response.Count < 1) { return; }
                        ChkLstTransactionsProcessed.Items.Add(response[0]);
        ...
        {//The Return() operation is used to return funds to a payment account without associating the return with a specific transaction that has been previously captured.
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                ...
                {
                    BankcardTransaction BCtransaction = dg.SetBankCardTxnData();
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.Return, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                }
                catch (Exception ex) { MessageBox.Show(ex.Message); }
                finally { Cursor = Cursors.Default; }
            }
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    foreach (ResponseDetails _RD in txnsToProcess)
                    {
                        ...
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.Adjust, null, null, null, null, aTransaction, null, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                    }
                }
                catch (Exception ex) { MessageBox.Show(ex.Message); }
                finally { Cursor = Cursors.Default; }
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    foreach (ResponseDetails _RD in txnsToProcess)
                    {
                        ...
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.Undo, null, null, null, null, null, uTransaction, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                    }
                }
                catch (Exception ex) { MessageBox.Show(ex.Message); }
                finally { Cursor = Cursors.Default; }
        ...
        private void cmdVerify_Click(object sender, EventArgs e)
        {
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    processResponse(Helper.ProcessBCPTransaction(TransactionType.Verify, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, false, ChkForceCloseBatch.Checked));
                }
                catch (Exception ex) { MessageBox.Show(ex.Message); }
                finally { Cursor = Cursors.Default; }
            }
         ...
         // The following will use an Authorize follwed by the RequestTransaction to simulate a dropped response.
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked, ChkForceCloseBatch.Checked);
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.Message);
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    {//This is a host capture service so use the AuthorizeAndCapture transaction
                        processResponse(Helper.ProcessBCPTransaction(TransactionType.AuthorizeAndCapture, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked, ChkForceCloseBatch.Checked));
                    }
                }
                catch (Exception ex) { MessageBox.Show(ex.Message); }
                finally { Cursor = Cursors.Default; }
        ...
        private void CmdMagensa_Click(object sender, EventArgs e)
        {
            Cursor = Cursors.WaitCursor;

            //Check to see if this transaction type is supported
            if (!SupportedTxnTypes.Authorize) { MessageBox.Show("Authorize Not Supported"); Cursor = Cursors.Default; return; }
            //Check to see if the transaction is a PINDebit and that the AuthorizeAndCapture is used.
            if (chkProcessAsPINDebitTxn.Checked) { MessageBox.Show("A PINDebit transaction can only be processed as an AuthorizeAndCapture Transaction"); Cursor = Cursors.Default; return; }
            ...
            if (_bcs != null) //Process a BankCard Transaction
            {
                try
                {
                    ...
                    Magensa MG = new Magensa();
                    MG.CallingForm(ref BCtransaction);
                    MG.ShowDialog(this);
                    if (!MG.ProcessTransaction){return;}

                    if (ChkMagensaAuthorizeAndCapture.Enabled && ChkMagensaAuthorizeAndCapture.Checked)
                    {
                        //Temporary since Magensa does not pass back card type and masked pan
                        List<ResponseDetails> RD = Helper.ProcessBCPTransaction(TransactionType.AuthorizeAndCapture, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked, ChkForceCloseBatch.Checked);
                    ...
                    {
                        //Temporary since Magensa does not pass back card type and masked pan
                        List<ResponseDetails> RD = Helper.ProcessBCPTransaction(TransactionType.Authorize, BCtransaction, null, null, null, null, null, null, null, ChkAcknowledge.Checked, ChkUserWorkflowId.Checked, ChkForceCloseBatch.Checked);
                        RD[0].CardType = MG.CardType;
                        RD[0].MaskedPan = MG.MaskedPAN;
                        processResponse(RD);
                    }
        ...
        private bool AvailableTxnTypes(Operations supportedTxnTypes)
        {
            ...
            //Check Magensa
            if (Convert.ToBoolean(ConfigurationSettings.AppSettings["TxnData_ProcessMagensaTxn"]) & (supportedTxnTypes.Authorize | supportedTxnTypes.AuthAndCapture))
